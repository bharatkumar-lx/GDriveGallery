 ...
 const GLogin = ({navigation}) => {
   ...
   useEffect(() => {
     ...
     GoogleSignin.configure({
       ...
       webClientId: '352176603330-s4tj27j0iarpvn4k3nnaioo66gg8qq5j.apps.googleusercontent.com', // client ID of type WEB for your server (needed to verify user ID and offline access)
